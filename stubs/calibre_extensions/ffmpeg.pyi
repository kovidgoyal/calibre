def resample_raw_audio_16bit(input_data: bytes, input_sample_rate: int, output_sample_rate: int, input_num_channels: int = 1, output_num_channels: int = 1) -> bytes:
...
def transcode_single_audio_stream(input_file_like_object: object, output_file_like_object: object, output_bitrate: int = 0, container_format: str = '', output_codec_name: str = '') -> None:

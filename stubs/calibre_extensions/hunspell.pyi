...
class Dictionary:
    ...
    def suggest(self, word: str) -> tuple[str, ...]:
        """Provide suggestions for the given word. The input word must be a unicode object.

        If encoding of the word to the encoding of the dictionary fails, a
        UnicodeEncodeError is raised. Returns the list of suggested words as unicode objects.
        """
        pass

...
def init(compiled_token_regexps: Any, unicode_unescape: Any, newline_unescape: Any, simple_unescape: Any, find_newlines: Any, token_dispatch: Any, compiled_token_indexes: dict[str, int], colon: str, scolon: str, lpar: str, rpar: str, lbrace: str, rbrace: str, lbox: str, rbox: str, delim_tok: str, integer: str, string_tok: str) -> None:

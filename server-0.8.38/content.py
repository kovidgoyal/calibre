...
class ContentServer(object):
    ...
    def index_v2(self, **kwargs):
        ...
        return P('content_server/v2/index.html', data=True).decode('utf-8').replace('{prefix}', self.opts.url_prefix)

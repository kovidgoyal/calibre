...
QNativeInterface = PyQt6.QtCore.QNativeInterface
...
QPyAbstractRange = PyQt6.QtCore.QPyAbstractRange
QPySequenceRange = PyQt6.QtCore.QPySequenceRange
QPyTableRange = PyQt6.QtCore.QPyTableRange
QRandomGenerator = PyQt6.QtCore.QRandomGenerator
QRangeModel = PyQt6.QtCore.QRangeModel
...
qEnvironmentVariableIntegerValue = PyQt6.QtCore.qEnvironmentVariableIntegerValue
...
QFontVariableAxis = PyQt6.QtGui.QFontVariableAxis
...
QPainterStateGuard = PyQt6.QtGui.QPainterStateGuard
QPalette = PyQt6.QtGui.QPalette
QPdfOutputIntent = PyQt6.QtGui.QPdfOutputIntent
...
QStyleOptionMenuItemV2 = PyQt6.QtWidgets.QStyleOptionMenuItemV2
...
QDnsTlsAssociationRecord = PyQt6.QtNetwork.QDnsTlsAssociationRecord
QFormDataBuilder = PyQt6.QtNetwork.QFormDataBuilder
QFormDataPartBuilder = PyQt6.QtNetwork.QFormDataPartBuilder
...
QNetworkRequestFactory = PyQt6.QtNetwork.QNetworkRequestFactory
...
QRestAccessManager = PyQt6.QtNetwork.QRestAccessManager
QRestReply = PyQt6.QtNetwork.QRestReply
...
QAudioBufferOutput = PyQt6.QtMultimedia.QAudioBufferOutput
...
QPlaybackOptions = PyQt6.QtMultimedia.QPlaybackOptions

...
class Renderer(QWebEnginePage):
    ...
    def __init__(self, opts, parent, log):
        ...
        s.setFontSize(QWebEngineSettings.FontSize.DefaultFontSize, opts.pdf_default_font_size)
        s.setFontSize(QWebEngineSettings.FontSize.DefaultFixedFontSize, opts.pdf_mono_font_size)

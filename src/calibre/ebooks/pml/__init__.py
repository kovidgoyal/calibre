...
A_CHARS = list(range(160, 256)) + list(range(130, 136)) + list(range(138, 141)) + \
    list(range(145, 152)) + list(range(153, 157)) + [159]

# Extended Unicode characters supported by PML
Latin_ExtendedA = list(range(0x0100, 0x0104)) + [0x0105, 0x0107, 0x010C, 0x010D,
    0x0112, 0x0113, 0x0115, 0x0117, 0x0119, 0x011B, 0x011D, 0x011F, 0x012A,
    0x012B, 0x012D, 0x012F, 0x0131, 0x0141, 0x0142, 0x0144, 0x0148] + \
    list(range(0x014B, 0x014E)) + [0x014F, 0x0151, 0x0155] + list(range(0x0159, 0x015C)) + \
...
Spacing_Modifier_Letters = [0x02BE, 0x02BF, 0x02C7, 0x02C8, 0x02CC, 0x02D0,
    0x02D8, 0x02D9]
Greek_and_Coptic = list(range(0x0391, 0x03A2)) + list(range(0x03A3, 0x03AA)) + \
    list(range(0x03B1, 0x03CA)) + [0x03D1, 0x03DD]
...
Latin_Extended_Additional = [0x1E0B, 0x1E0D, 0x1E17, 0x1E22, 0x1E24, 0x1E25,
    ...
    list(range(0x1E59, 0x1E5C)) + [0x1E61, 0x1E63, 0x1E6B, 0x1E6D, 0x1E6F, 0x1E91,
...
Miscellaneous_Symbols = list(range(0x261C, 0x2641)) + list(range(0x2642, 0x2648)) + \
    list(range(0x2660, 0x2664)) + list(range(0x266D, 0x2670))
Dingbats = [0x2713, 0x2720]
Private_Use_Area = list(range(0xE000, 0xE01D)) + list(range(0xE01E, 0xE029)) + \
    list(range(0xE02A, 0xE052))

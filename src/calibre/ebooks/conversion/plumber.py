...
class Plumber:
    ...
    def __init__(
        ...
        self.pipeline_options = [
            ...
            OptionRecommendation(
                ...
                help=_(
                    'Specify the output profile. The output profile '
            ...
            OptionRecommendation(
                name='font_size_mapping',
                recommended_value=None,
                level=OptionRecommendation.LOW,
                help=_(
                    'Mapping from CSS font names to font sizes in pts. '
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'XPath expression that specifies all tags that '
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Maximum number of links to insert into the TOC. Set to 0 '
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Either the path to a CSS stylesheet or raw CSS. '
            ...
            OptionRecommendation(
                name='transform_css_rules',
                recommended_value=None,
                level=OptionRecommendation.LOW,
                help=_('Rules for transforming the styles in this book. These rules are applied after all other CSS processing is done.'),
            ),
            OptionRecommendation(
                name='transform_html_rules',
                recommended_value=None,
                level=OptionRecommendation.LOW,
                help=_('Rules for transforming the HTML in this book. These rules are applied after the HTML is parsed, but before any other transformations.'),
            ),
            OptionRecommendation(
                name='filter_css',
                recommended_value=None,
                level=OptionRecommendation.LOW,
                help=_(
                    'A comma separated list of CSS properties that '
            ...
            OptionRecommendation(
                name='page_breaks_before',
                recommended_value="//*[name()='h1' or name()='h2']",
                level=OptionRecommendation.LOW,
                help=_('An XPath expression. Page breaks are inserted before the specified elements. To disable use the expression: /'),
            ),
            OptionRecommendation(
                name='remove_fake_margins',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_(
                    'Some documents specify page margins by '
            ...
            OptionRecommendation(
                name='add_alt_text_to_img',
                recommended_value=False,
                level=OptionRecommendation.LOW,
                help=_(
                    'When an <img> tag has no alt attribute, check the associated image file for metadata that specifies alternate text, and'
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Set the top margin in pts. Default is %default. '
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Set the bottom margin in pts. Default is %default. '
                    'Setting this to less than zero will cause no margin to be set '
                    '(the margin setting in the original document will be preserved). '
                    'Note: Page oriented formats such as PDF and DOCX have their own'
                    ' margin settings that take precedence.'
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Set the left margin in pts. Default is %default. '
                    'Setting this to less than zero will cause no margin to be set '
                    '(the margin setting in the original document will be preserved). '
                    'Note: Page oriented formats such as PDF and DOCX have their own'
                    ' margin settings that take precedence.'
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Set the right margin in pts. Default is %default. '
                    'Setting this to less than zero will cause no margin to be set '
                    '(the margin setting in the original document will be preserved). '
                    'Note: Page oriented formats such as PDF and DOCX have their own'
                    ' margin settings that take precedence.'
            ...
            OptionRecommendation(
                name='remove_paragraph_spacing_indent_size',
                recommended_value=1.5,
                level=OptionRecommendation.LOW,
                help=_(
                    'When calibre removes blank lines between paragraphs, it automatically '
            ...
            OptionRecommendation(
                ...
                recommended_value=False,
                level=OptionRecommendation.LOW,
                help=_('Insert a blank line between paragraphs. Will not work if the source file does not use paragraphs (<p> or <div> tags).'),
            ),
            OptionRecommendation(
                name='insert_blank_line_size',
                recommended_value=0.5,
                level=OptionRecommendation.LOW,
                help=_('Set the height of the inserted blank lines (in em). The height of the lines between paragraphs will be twice the value set here.'),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                name='smarten_punctuation',
                recommended_value=False,
                level=OptionRecommendation.LOW,
                help=_('Convert plain quotes, dashes and ellipsis to their typographically correct equivalents. For details, see: {}').format(
                    'https://daringfireball.net/projects/smartypants.'
                ),
            ),
            OptionRecommendation(
                name='unsmarten_punctuation',
                recommended_value=False,
                level=OptionRecommendation.LOW,
                help=_('Convert fancy quotes, dashes and ellipsis to their plain equivalents.'),
            ),
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                short_switch='m',
                help=_('Read metadata from the specified OPF file. Metadata read from this file will override any metadata in the source file.'),
            ),
            OptionRecommendation(
                name='asciiize',
                recommended_value=False,
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                help=_(
                    'Preserve ligatures present in the input document. '
            ...
            OptionRecommendation(name='title', recommended_value=None, level=OptionRecommendation.LOW, help=_('Set the title.')),
            OptionRecommendation(
                name='authors',
                recommended_value=None,
                level=OptionRecommendation.LOW,
                help=_('Set the authors. Multiple authors should be separated by ampersands.'),
            ),
            OptionRecommendation(
                name='title_sort',
                recommended_value=None,
            ...
            OptionRecommendation(name='isbn', recommended_value=None, level=OptionRecommendation.LOW, help=_('Set the ISBN of the book.')),
            OptionRecommendation(
                name='tags',
                recommended_value=None,
                level=OptionRecommendation.LOW,
            ...
            OptionRecommendation(name='language', recommended_value=None, level=OptionRecommendation.LOW, help=_('Set the language.')),
            OptionRecommendation(
                name='pubdate',
                recommended_value=None,
                level=OptionRecommendation.LOW,
            ...
            OptionRecommendation(
                name='enable_heuristics',
                recommended_value=False,
                level=OptionRecommendation.LOW,
                help=_('Enable heuristic processing. This option must be set for any heuristic processing to take place.'),
            ),
            OptionRecommendation(
                name='markup_chapter_headings',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_(
            ...
            OptionRecommendation(
                name='italicize_common_cases',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_('Look for common words and patterns that denote italics and italicize them.'),
            ),
            OptionRecommendation(
                name='fix_indents',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_('Turn indentation created from multiple non-breaking space entities into CSS indents.'),
            ),
            OptionRecommendation(
                name='html_unwrap_factor',
            ...
            OptionRecommendation(
                name='delete_blank_paragraphs',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_('Remove empty paragraphs from the document when they exist between every other paragraph'),
            ),
            OptionRecommendation(
                name='format_scene_breaks',
                recommended_value=True,
                level=OptionRecommendation.LOW,
                help=_('Left aligned scene break markers are center aligned. Replace soft scene breaks that use multiple blank lines with horizontal rules.'),
            ),
            OptionRecommendation(
                name='replace_scene_breaks',
                recommended_value='',
                level=OptionRecommendation.LOW,
                help=_('Replace scene breaks with the specified text. By default, the text from the input document is used.'),
            ),
            OptionRecommendation(
                name='dehyphenate',
                recommended_value=True,
            ...
            OptionRecommendation(
                ...
                recommended_value='',
                level=OptionRecommendation.LOW,
                help=_('Search pattern (regular expression) to be replaced with sr1-replace.'),
            ),
            OptionRecommendation(
                name='sr1_replace',
                recommended_value='',
            ...
            OptionRecommendation(
                ...
                recommended_value='',
                level=OptionRecommendation.LOW,
                help=_('Search pattern (regular expression) to be replaced with sr2-replace.'),
            ),
            OptionRecommendation(
                name='sr2_replace',
                recommended_value='',
            ...
            OptionRecommendation(
                ...
                recommended_value='',
                level=OptionRecommendation.LOW,
                help=_('Search pattern (regular expression) to be replaced with sr3-replace.'),
            ),
            OptionRecommendation(
                name='sr3_replace',
                recommended_value='',
        ...
        def set_profile(profiles, which):
            ...
            for x in profiles():
                if x.short_name == sval:
                    ...
                    return
            self.log.warn(f'Profile ({which}) {sval!r} is no longer available, using default')
            for x in profiles():
    ...
    def run(self):
        ...
        if self.input_fmt == 'azw4' and self.output_plugin.file_type == 'pdf':
            self.ui_reporter(
                0.01,
                'AZW4 files are simply wrappers around PDF files. Skipping the conversion and unwrapping the embedded PDF instead',
            )

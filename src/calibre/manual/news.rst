...
.. note:: On OS X, the ebook-convert command will not be avaialble by default. Go to Preferences->Miscellaneous and click the install command line tools button to make it available.

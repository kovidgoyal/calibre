...
To learn more about writing advanced recipes using some of the facilities, available in ``BasicNewsRecipe`` you should consult the following sources:
    ...
    `BasicNewsRecipe <http://calibre.kovidgoyal.net/browser/trunk/src/calibre/web/feeds/news.py>`_
        The source code of ``BasicNewsRecipe``

    `Built-in recipes <http://calibre.kovidgoyal.net/browser/trunk/src/calibre/web/feeds/recipes>`_

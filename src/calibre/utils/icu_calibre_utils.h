...
static UChar *
python_to_icu(PyObject *obj, int32_t *osz) {
    UChar *ans = NULL;
    Py_ssize_t sz = 0;
    ...
    if (PyUnicode_READY(obj) == -1) { return NULL; }
    ...
    switch (PyUnicode_KIND(obj)) {
        ...
        case PyUnicode_4BYTE_KIND:
            ...
            u_strFromUTF32(ans, 2 * (sz + 1), (int32_t *)osz, (UChar32 *)PyUnicode_4BYTE_DATA(obj), (int32_t)sz, &status);
            break;
    }
...
static UChar32 *
python_to_icu32(PyObject *obj, int32_t *osz) {
    UChar32 *ans = NULL;
    Py_ssize_t sz = 0;
    int i;
...
static PyObject *
icu_to_python(const UChar *src, int32_t sz) {

...
static unsigned long bigbyte[24] = {0x800000L, 0x400000L, 0x200000L, 0x100000L, 0x80000L, 0x40000L, 0x20000L, 0x10000L, 0x8000L, 0x4000L, 0x2000L, 0x1000L,
                                    0x800L,    0x400L,    0x200L,    0x100L,    0x80L,    0x40L,    0x20L,    0x10L,    0x8L,    0x4L,    0x2L,    0x1L};

/* Use the key schedule specified in the Standard (ANSI X3.92-1981). */

static unsigned char pc1[56] = {56, 48, 40, 32, 24, 16, 8,  0, 57, 49, 41, 33, 25, 17, 9,  1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35,
...
static unsigned char pc2[48] = {13, 16, 10, 23, 0,  4,  2,  27, 14, 5,  20, 9,  22, 18, 11, 3,  25, 7,  15, 6,  26, 19, 12, 1,
                                40, 51, 30, 36, 46, 54, 29, 39, 50, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31};

void
deskey(unsigned char *key, short edf) /* Thanks to James Gillogly & Phil Karn! */
{
    int i, j, l, m, n;
...
static void
des2key(unsigned char *hexkey, short mode) /* stomps on Kn3 too */
{
    short revmod;
...
void Ddes(from, into) unsigned char *from, *into; /* unsigned char[8] */
{
    unsigned long work[2];
...
void D2des(from, into) unsigned char *from; /* unsigned char[16] */
...
void makekey(aptr, kptr) char *aptr; /* NULL-terminated  */
...
void make2key(aptr, kptr) char *aptr; /* NULL-terminated   */
...
void cp2key(into) unsigned long *into; /* unsigned long[64] */
{
    unsigned long *from, *endp;
...
void des3key(hexkey, mode) unsigned char *hexkey; /* unsigned char[24] */
short mode;
{
...
void cp3key(into) unsigned long *into; /* unsigned long[96] */
{
    unsigned long *from, *endp;
...
void use3key(from) unsigned long *from; /* unsigned long[96] */
{
    unsigned long *to, *endp;
...
void make3key(aptr, kptr) char *aptr; /* NULL-terminated   */

...
def parse_restriction(raw):
    ...
    r['library_restrictions'] = {k.lower(): v or '' for k, v in six.iteritems(lr)}
    return r
...
def serialize_restriction(r):
    ...
    for x in 'allowed_library_names blocked_library_names'.split():
        ...
        if v:
            ans[x] = list(v)
    ans['library_restrictions'] = {l.lower(): v or '' for l, v in six.iteritems(r.get('library_restrictions', {}))}
